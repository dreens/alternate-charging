...
\caption{
This schematic illustrates a new strategy for Stark deceleration, which critically relies on certain distributions of the electric field, which may be generated by charging the decelerator electrodes in novel ways. Distributions B and C feature strong transverse focusing in the regions where molecules would normally pass between grounded pin pairs. On-axis energy diagrams are shown for modes of operation incorporating these field distributions termed SF for strong focusing and VSF for very strong focusing. A less strongly focusing mode (F) is also described in the text but omitted from this diagram for reasons of clarity. Primes indicate translation of a distribution to the next pin pair. Earlier operation modes employing the original strategy, S\,=\,1 and its S\,=\,3 overtone~\cite{VanDeMeerakker2005a}, are shown for comparison.\vspace{-4mm}
}

...
Improved focusing is also found to result in a recovery of gains in molecule yield with increased operating voltage.
The improvement is more significant for species which require more time for deceleration, so that Stark deceleration of less readily polarized species is now more feasible.
\end{abstract}
...
Unlike TW however, the performance of F, SF, and S\,=\,1 all degrade below $50$~m/s due to the breakdown of the traveling trap approximation and the discontinuous nature of pulsed deceleration.
...
In addition to the two new operation modes identified here, a whole class of deceleration modes based upon the same strategy is ready for exploration.

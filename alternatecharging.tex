...
We introduce a new strategy that offers many-fold performance improvements across all useful operating conditions for a Stark decelerator, including an increase in molecule number at trappable final velocities by a factor of $4.7\pm0.8$.
Our strategy also makes the application of Stark deceleration to less readily polarized species and to longer devices more feasible.
\end{abstract}
...
Our strategy works with conventional geometry and electronics, but fully resolves transverse challenges and offers more than fivefold gains even at very low speeds.

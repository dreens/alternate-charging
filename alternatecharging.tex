...
%%%%%%%%%%%%%%%%%%%%%
\begin{abstract}
Stark deceleration is an important technology for molecular beams, and has enabled numerous trapping and collisional studies.
...
We introduce a new operation strategy that resolves focusing limitations, offers significant performance improvements, and requires no hardware modifications. 
We explore the physics underlying these improvements, and verify our results for hydroxyl radicals.
At trappable final velocities, molecule flux improves by a factor of $4.7\pm0.8$.

...
We compute this in Appendix~\ref{app:effpot} and use it to numerically evaluate minimum depths over various phase angles and operation modes in Fig.~\ref{fig:efftrap}. 
